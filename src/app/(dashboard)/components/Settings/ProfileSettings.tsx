      ...
      <div className='w-full mx-auto px-3 py-8'>
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8'>
          ...
          <div className='lg:col-span-1'>
            <div className='bg-white rounded-2xl border border-slate-200 p-3 md:p-5 h-fit sticky top-6'>
            ...
            {/* Additional Settings */}
            <div className='hidden md:flex-col w-full mt-4 rounded-xl border border-gray-200 p-3 md:p-5'>
          ...
          <div className='lg:col-span-2'>
            <div className='bg-white rounded-2xl border border-slate-200 p-3 md:p-5'>
              {/* Card Header */}
          ...
          {/* Additional Settings */}
          <div className='flex-col md:hidden w-full mt-4 rounded-xl border border-gray-200 p-3 md:p-5'>
            <h2 className='text-xl font-semibold text-foreground mb-4'>
              Account Settings
            </h2>
            <div className='space-y-4'>
